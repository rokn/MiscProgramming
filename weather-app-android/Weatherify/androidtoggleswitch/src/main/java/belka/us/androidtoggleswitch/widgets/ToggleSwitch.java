...
public class ToggleSwitch extends BaseToggleSwitch{
    ...
    public void setCheckedTogglePosition(final int position){
        final LinearLayout toggleSwitchesContainer = getToggleSwitchesContainer();
        ...
        if (toggleSwitchesContainer.getChildAt(position) == null) {

            toggleSwitchesContainer.post(runnable);
