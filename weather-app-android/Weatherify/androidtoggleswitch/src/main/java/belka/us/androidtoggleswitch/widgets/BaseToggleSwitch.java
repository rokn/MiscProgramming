...
public abstract class BaseToggleSwitch extends LinearLayout implements View.OnClickListener {
    ...
    private void addToggleBtn(String text) {
        ...
        final TextView toggleBtnTxt = toggleSwitchButton.getTextView();

        toggleBtnTxt.setText(text);
        toggleBtnTxt.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);

        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams((int) toggleWidth, LayoutParams.MATCH_PARENT);
        ...
        toggleBtnTxt.setOnClickListener(this);
...
//                    null);
    ...
    protected void setColors(ToggleSwitchButton toggleSwitchButton, int bgColor, int textColor) {
        final ShapeDrawable sd = new ShapeDrawable(buildRect(toggleSwitchButton));
